...
# also Interactive Documents 08-09-001
...
st.markdown("""
            ...
            The model (Confined_pumping.gpt) and the generated data (confined_pumping.csv) are available in GitHub (https://github.com/gw-inux/iNUX-Interactive-Documents/tree/main/08_Groundwater_Modeling/09_Model_Evaluation_Verification/DATA)
           """)
lc0, cc0, rc0 = st.columns((20,60,20))
with cc0:
    st.image('FIGS/confined_aquifer_model.png', caption="The numerical model (extent is 2,000 x 2,000 x 20 m³) with the central abstraction well to simulate pumping from a confined aquifer. The colors indicate the drawdown after one day of pumping.")
