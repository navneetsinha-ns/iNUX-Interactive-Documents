...
- Interactive applications implemented as **Streamlit apps**
- Executable **Jupyter Notebooks** for transparent and reproducible workflows
- Associated educational resources such as digital questions and supporting data
...
👉 **[iNUX Interactive Documents Web Catalog](https://gw-inux.github.io/iNUX-Interactive-Documents)**

The catalog provides:
- A structured overview of all interactive materials
- Direct links to deployed Streamlit applications and executable notebooks
- Metadata on topics, prerequisites, and intended use cases
...
The categorization defines:
- Main thematic categories and subcategories
- A systematic numbering scheme for all resources
- A common reference system used across repositories, reports, and the web catalog

The full description of the categorization concept is documented in the iNUX Handbook:
