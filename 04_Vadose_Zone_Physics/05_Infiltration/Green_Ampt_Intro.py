...
path_quest_ini   = "04_Vadose_Zone_Physics/05_Infiltration/questions/green_ampt_ini.json"
path_quest_final = "04_Vadose_Zone_Physics/05_Infiltration/questions/green_ampt_final.json"
...
st.image("04_Vadose_Zone_Physics/05_Infiltration/FIGS/Green_Ampt_Model.png", caption="Figure 1: Soil water profile for the case of ponding (a). Volumetric water content as a function of soil depth for a (b) 'real situation' and (c) assumptions underlying the Green-Ampt equation.")
...
with st.expander("Show more explanation", icon ="📑"):
        ...
        st.image("04_Vadose_Zone_Physics/05_Infiltration/FIGS/Doppelring-Infiltrometer.jpg", caption='Figure 2: Double Ring Infiltrometer', width=350)
